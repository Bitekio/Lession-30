...
в) Отобразите матрицу данных в виде графика.
"""
...
class DataVisualizer:
    ...
    def plot_scatter(self) -> None:
        """Отображает данные DataFrame в виде диаграммы рассеяния."""
        plt.scatter(self.df.index, self.df.values)
    ...
    def plot_bar(self) -> None:
        ...
        self.df.plot(kind='bar', title=self.title)
        plt.xlabel(self.xlabel)
        plt.ylabel(self.ylabel)
        plt.show()
